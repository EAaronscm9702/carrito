                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="operaciones/registrar_usuario.php" method="post">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-md-3 col-sm-12">FECHA DE INICIO:</label>
                                        <input type="date"
                                        name="feini"
                                        placeholder=""
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-md-3 col-sm-12">FECHA FINAL:</label>
                                        <input type="date"
                                        name="fefin"
                                        placeholder=""
                                        class="form-control col-lg-3 col-md-3 col-sm-12" required>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-md-3 col-sm-12">FECHA DE HORA DE REPORTE:</label>
                                        <input type="date"
                                        name="fehore"
                                        placeholder=""
                                        class="form-control col-lg-3 col-md-3 col-sm-12" required>

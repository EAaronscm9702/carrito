                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        <div class="form-group">
                                            <label for="simpleinput">Dni</label>
                                            <input type="number" id="simpleinput" class="form-control" placeholder="Ingrese su Dni">
                                        </div>

                                        <div class="form-group">
                                            <label for="simpleinput">Apellidos_Nombres</label>
                                            <input type="text" id="simpleinput" class="form-control" placeholder="Ingrese sus Apellidos y Nombres">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="simpleinput" class="form-control" placeholder="Ingrese su numero telefonico">
                                        </div>

                                        <div class="form-group">
                                            <label for="simpleinput">Fecha_Nacimiento</label>
                                            <input type="date" id="simpleinput" class="form-control" placeholder="Ingrese su Fecha de nacimiento">
                                        </div>
